...
public class EnemyType2 extends Enemy {
    ...
    public EnemyType2(double x, double y, Image sprite) {
         ...
         *
         * <p>This is critical to ensure collision detection matches what
         * the player visually perceives. Without this adjustment, collisions
         * may be triggered before sprites visually overlap.</p>
         */
        setSize(120, 120);
